...
void definePlantConservatoryObjects() {
    ...
    roomObjects[PLANT_CONSERVATORY]["vine"] =
        "Although vines cover much of the glass of the dome, the vines that stick out to you or the ones that lead up to a room. It looks like you could climb them.";
