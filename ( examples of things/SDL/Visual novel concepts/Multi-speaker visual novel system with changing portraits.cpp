...
void whatPortrait(SDL_Renderer* renderer, SDL_Texture* portraitTexture) {
    SDL_Rect portraitImageRect;
    ...
    if (currentSpeakingCharacter == AERITH) {
        ...
        SDL_Surface* portraitSurface = IMG_Load("image.jpg");
        if (!portraitSurface)
        {
            SDL_Log("%s", IMG_GetError());
        }
...
int main(int argc, char* argv[])
{
    ...
    while (running)
    {
        ...
        whatPortrait(renderer, portraitTexture);
